                                            ...
                                            <form action="update/update-biodata.php" method="POST" enctype="multipart/form-data">
                                                <div class="card-body ">
                                                    ...
                                                    <div class="row mb-3">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input class="form-control" type="text" name="jenispekerjaan" value="<?= $anggota['jenis_pekerjaan']; ?>">
                                                        </div>
                                                    </div>
                                                    <div class="row mb-3">
                                                        <label for="perusahaan" class="col-sm-2 col-form-label">Nama Perusahaan</label>
                                                        <div class="col-sm-10">
                                                            <input class="form-control" type="text" name="perusahaan" value="<?= $anggota['nama_perusahaan']; ?>">
                                                        </div>
                                                    </div>
                                                    <div class="row mb-3">
                                                    ...
                                                    <div class="row mb-3">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input class="form-control" type="text" name="notelpperusahaan" value="<?= $anggota['telp_perusahaan']; ?>">
                                                        </div>
                                                    </div>
                                                    <div class="row mb-3">
                                                        <label for="alamatperusahaan" class="col-sm-2 col-form-label">Alamat Perusahaan</label>
                                                        <div class="col-sm-10">
                                                            <input class="form-control" type="text" name="alamatperusahaan" value="<?= $anggota['alamat_perusahaan']; ?>">
                                                        </div>
                                                    </div>
                                                    <div class="row mb-3">
                                                        <label for="jumlahgaji" class="col-sm-2 col-form-label">Jumlah Gaji</label>
                                                        <div class="col-sm-10">
                                                            <input class="form-control" type="text" name="jumlahgaji" value="<?= $anggota['jumlah_gaji']; ?>">
                                                        </div>
                                                    </div>
