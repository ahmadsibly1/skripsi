                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body ">
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input class="form-control" type="text" value="<?= $anggota['jenis_pekerjaan']; ?>" aria-label="Disabled input example" disabled readonly>
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
                                                    <label for="perusahaan" class="col-sm-2 col-form-label">Nama Perusahaan</label>
                                                    <div class="col-sm-10">
                                                        <input class="form-control" type="text" value="<?= $anggota['nama_perusahaan']; ?>" aria-label="Disabled input example" disabled readonly>
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
                                                    <label for="jabatan" class="col-sm-2 col-form-label">Jabatan</label>
                                                    <div class="col-sm-10">
                                                        <input class="form-control" type="text" value="<?= $anggota['jabatan']; ?>" aria-label="Disabled input example" disabled readonly>
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
                                                    <label for="notelpperusahaan" class="col-sm-2 col-form-label">No Telp Perusahaan</label>
                                                    <div class="col-sm-10">
                                                        <input class="form-control" type="text" value="<?= $anggota['telp_perusahaan']; ?>" aria-label="Disabled input example" disabled readonly>
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
                                                    <label for="alamatperusahaan" class="col-sm-2 col-form-label">Alamat Perusahaan</label>
                                                    <div class="col-sm-10">
                                                        <input class="form-control" type="text" value="<?= $anggota['alamat_perusahaan']; ?>" aria-label="Disabled input example" disabled readonly>
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
                                                    <label for="jumlahgaji" class="col-sm-2 col-form-label">Jumlah Gaji</label>
                                                    <div class="col-sm-10">
                                                        <input class="form-control" type="text" value="<?= rupiah($anggota['jumlah_gaji']); ?>" aria-label="Disabled input example" disabled readonly>
                                                    </div>
                                                </div>
