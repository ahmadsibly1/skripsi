            ...
            <form action="conf/pendaftaran.php" method="POST" enctype="multipart/form-data">
              <div class="card-body">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="jenispekerjaan" name="jenispekerjaan" placeholder="*" required>
                  </div>
                </div>
                <div class="row mb-3">
                  <label for="perusahaan" class="col-sm-2 col-form-label">Nama Perusahaan</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="perusahaan" name="perusahaan" placeholder="*" required>
                  </div>
                </div>
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="jumlahgaji" name="jumlahgaji" placeholder="3000000" required>
                  </div>
                </div>
              </div>
